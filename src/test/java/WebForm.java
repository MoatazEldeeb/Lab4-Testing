...
public class WebForm extends PageObj{
    private final String FIRST_NAME = "Moataz";
    private final String LAST_NAME = "Alaa";
    private final String JOB_TITLE = "Engineer";
    ...
    private WebElement radio_btn_1;
